      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            {config.tagline && (
              <p className="text-slate-400 leading-relaxed max-w-sm">{config.tagline}</p>
            )}
                  ...
                  {section.links?.map((link, linkIdx) => (
                    <li key={linkIdx}>
                      <Link
                        ...
                        className="text-slate-400 hover:text-primary transition-colors duration-200 block"
                      >
                        {link.text}
                      </Link>
                    </li>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
          <p>{config.copyright || ` ${currentYear} All rights reserved.`}</p>
          <div className="flex gap-6">
            <Link href={'/privacy' as any} className="hover:text-slate-300 transition-colors">
              Privacy Policy
            </Link>
            <Link href={'/terms' as any} className="hover:text-slate-300 transition-colors">
              Terms of Service
            </Link>
          </div>
        </div>
